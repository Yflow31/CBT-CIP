...
class LengthPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FromSpinner.adapter = ArrayAdapter.createFromResource(this,R.array.length_items,android.R.layout.simple_spinner_item).also {
            it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        }
        ToSpinner.adapter = ArrayAdapter.createFromResource(this,R.array.length_items,android.R.layout.simple_spinner_item).also {
            it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        }
    ...
    private fun calculate(selectedFrom: String, selectedTo: String) {
        ...
        val result = when {
            selectedFrom == "Kilometer" && selectedTo == "Meter" -> input * 1000
            selectedFrom == "Kilometer" && selectedTo == "Centimeter" -> input * 100000
            selectedFrom == "Kilometer" && selectedTo == "Inches" -> input * 39370
            selectedFrom == "Kilometer" && selectedTo == "Kilometer" -> input

            selectedFrom == "Meter" && selectedTo == "Kilometer" -> input / 1000
            selectedFrom == "Meter" && selectedTo == "Centimeter" -> input * 100
            selectedFrom == "Meter" && selectedTo == "Inches" -> input * 39.37
            selectedFrom == "Meter" && selectedTo == "Meter" -> input

            selectedFrom == "Centimeter" && selectedTo == "Kilometer" -> input / 100000
            selectedFrom == "Centimeter" && selectedTo == "Meter" -> input / 100
            selectedFrom == "Centimeter" && selectedTo == "Inches" -> input / 2.54
            selectedFrom == "Centimeter" && selectedTo == "Centimeter" -> input

            selectedFrom == "Inches" && selectedTo == "Kilometer" -> input / 39
            selectedFrom == "Inches" && selectedTo == "Meter" -> input / 39.37
            selectedFrom == "Inches" && selectedTo == "Centimeter" -> input * 2.54
            selectedFrom == "Inches" && selectedTo == "Inches" -> input
