...
class Volume : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FromSpinner.adapter = ArrayAdapter.createFromResource(this,R.array.Volume_items,android.R.layout.simple_spinner_item).also {
            it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        }
        ToSpinner.adapter = ArrayAdapter.createFromResource(this,R.array.Volume_items,android.R.layout.simple_spinner_item).also {
            it.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        }
    ...
    private fun calculate(selectedFrom: String, selectedTo: String) {
        ...
        val result = when {
            ...
            selectedFrom == "Liters" && selectedTo == "Milliliters" -> input * 1000
            selectedFrom == "Liters" && selectedTo == "Cubic meters" -> input * 0.001
            selectedFrom == "Liters" && selectedTo == "Liters" -> input

            selectedFrom == "Milliliters" && selectedTo == "Liters" -> input * 0.001
            selectedFrom == "Milliliters" && selectedTo == "Cubic meters" -> input * 0.000001
            selectedFrom == "Milliliters" && selectedTo == "Milliliters" -> input

            selectedFrom == "Cubic meters" && selectedTo == "Liters" -> input * 1000
            selectedFrom == "Cubic meters" && selectedTo == "Milliliters" -> input * 1000000
            selectedFrom == "Cubic meters" && selectedTo == "Cubic meters" -> input
